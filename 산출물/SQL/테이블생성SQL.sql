...
ALTER TABLE STO_ORDERS DROP CONSTRAINT FK_ORDER_MEMBER_ID;
ALTER TABLE ORDER_BOOK DROP CONSTRAINT FK_ORDER_BOOK_LISTING_NUMBER;
ALTER TABLE DIVIDEND_DETAILS DROP CONSTRAINT FK_DIVIDEND_DETAILS_MEMBER_ID;
ALTER TABLE DIVIDEND_DETAILS DROP CONSTRAINT FK_DIVIDEND_DETAILS_LISTING_NUMBER;
ALTER TABLE PUBLIC_OFFERING DROP CONSTRAINT FK_PUBLIC_OFFERING_MEMBER_ID;
ALTER TABLE PUBLIC_OFFERING DROP CONSTRAINT FK_PUBLIC_OFFERING_LISTING_NUMBER;
ALTER TABLE SELL_VOTE DROP CONSTRAINT FK_SELL_VOTE_MEMBER_ID;
...
CREATE TABLE REAL_ESTATE_INFO (
  ...
  FLOOR_AREA_RATIO NUMBER(3, 1) NOT NULL,       -- 용적률
  COMPLETION_DATE DATE NOT NULL,                -- 준공일
  LATITUDE NUMBER(3, 10) NOT NULL,              -- 위도
  LONGITUDE NUMBER(3, 10) NOT NULL,             -- 경도
...
CREATE TABLE PUBLICATION_INFO (
  LISTING_NUMBER NUMBER(8) PRIMARY KEY,         -- 매물번호
  SUBJECT VARCHAR2(30) NOT NULL,                -- 공모대상
  ...
  DIVIDEND_CYCLE NUMBER(3) NOT NULL,            -- 배당 주기
...
CREATE TABLE STO_ORDERS (
  ...
  WALLET_BALANCE NUMBER(13) NOT NULL,                           -- 거래후잔액
...
CREATE TABLE DIVIDEND_DETAILS (
  PAYOUT_NUMBER NUMBER(8) DEFAULT PN_SEQ.NEXTVAL PRIMARY KEY,       -- 지급 번호
  MEMBER_ID VARCHAR2(20) NOT NULL,                                  -- 회원 아이디
...
CREATE TABLE ANNOUNCEMENT (
  ID NUMBER(8) DEFAULT ANNOUNCEMENT_SEQ.NEXTVAl PRIMARY KEY,    -- 관리자 아이디
  TITLE VARCHAR2(30) NOT NULL,                                  -- 비밀번호
  CONTENT VARCHAR2(300) NOT NULL,                               -- 관리자 이름
